...
export function WorkshopSources({
  ...
  return (
    <SectionCard icon={<Link2Icon />} title={copy.sources} description={copy.sourcesDescription}>
      <SourceFields fields={fields} sourceInvalid={sourceInvalid} copy={copy} actions={actions} />
    </SectionCard>
  );
}
