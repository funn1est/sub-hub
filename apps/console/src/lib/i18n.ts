...
export const messages = {
  en: {
    ...
    client: {
      clash: {
        label: 'Clash / Mihomo',
        capability: 'Clash-family clients keep every protocol this Conversion Service accepts.',
      ...
      singbox: {
        label: 'sing-box',
        capability: 'This sing-box pin skips Hysteria2 gecko and pinSHA256.',
      },
      loon: {
        label: 'Loon',
        capability: 'Loon skips every TUIC node. VLESS Reality stays only with Vision.',
      },
      egern: {
        label: 'Egern',
        capability: 'Egern skips TUIC with non-default congestion and Trojan gRPC.',
      },
      surge: {
        label: 'Surge',
    ...
    preview: 'Preview',
    previewBlocked: 'Fill the origin and at least one source to emit a Subscription URL.',
  ...
  zh: {
    ...
    client: {
      clash: {
        label: 'Clash / Mihomo',
        capability: 'Clash 家族客户端会保留本 Conversion Service 接受的全部协议。',
