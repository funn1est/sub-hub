...
export const ACL4SSR_FAMILIES = Object.keys(ACL4SSR_PRESETS) as Acl4ssrFamily[];
...
export function configSelectionId(preset: ConfigPreset, pickingCustom: boolean): ConfigSelectionId {
